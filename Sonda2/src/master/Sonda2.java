...
public class Sonda2
{
	String sonda = "sensor2.txt";
	File archivo = new File(System.getProperty("user.home"), "/Desktop/sensor2.txt"); 
	File users = new File(System.getProperty("user.home"), "/Desktop/users2.txt");
	boolean loged = false;
